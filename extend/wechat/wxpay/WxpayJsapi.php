...
class WxpayJsapi extends Controller{
    /*
    配置参数
    */
    private $config = array(
        'appid' => "wxc1d81871ab73a013",   /*微信开放平台上的应用id*/
        'mch_id' => "1480998582",   /*微信申请成功之后邮件中的商户id*/
        'api_key' => "bzzrQTfurHmPDF3gash3KxGmVz1qz5Gl",    /*在微信商户平台上自己设定的api密钥 32位*/
        'notify_url' => 'https://api.ynyxlx.com/api/v1/getpayresult/wxpayapplet_notify', /*自定义的回调程序地址*/
        'SSLCERT_PATH' => 'jsapiCert/apiclient_cert.pem',//证书路径
        'SSLKEY_PATH' => 'jsapiCert/apiclient_key.pem',//证书路径
    );
     ...
     * @return   下单
     */
    public function getPrePayOrder($body, $out_trade_no, $total_fee,$openid,$trade_type){
